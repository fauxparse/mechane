// Naming a new Show (issue #604).
//
// A modal, and the only place the field exists: both offers to create a Show —
// the card at the head of the grid and the no-matches empty state — open this
// one, so the question is asked the same way and in the same place on screen
// wherever it comes from.
//
// #604 asked for the input not to be permanently on the page. A modal makes
// that stronger than an inline form did: there is exactly one field on screen
// and nothing else to look at, and Escape or Cancel disposes of it.
import {
  Button,
  Dialog,
  DialogClose,
