// What a search with no matches looks like (issue #604).
//
// It replaces the grid rather than sitting under it, and it takes the New Show
// card's job while it is up: two invitations to make a Show, one of them a
// dashed rectangle in a grid of nothing, is worse than one that says what
// happened.
//
 ...
 * repo has no illustration set, and drawn in `currentColor` so it inherits the
 * muted foreground and survives a theme or palette change.
 */
  ...
  return (
    ...
    >
      ...
      {/*
        ...
        would paint the wrong shade, since this sits on the library half's
        `bg-sunken`.
      */}
