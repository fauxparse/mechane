  ...
  return {
    ...
    inspector: graphInspectorEditing(
      ...
      editing.sourceValues,
      {
        ...
        setTransformerFormula: editing.setTransformerFormula,
        setTransformerOutputType: editing.setTransformerOutputType,
        setTransformerKind: editing.setTransformerKind,
        addTransformerPort: editing.addTransformerPort,
        renameTransformerPort: editing.renameTransformerPort,
        reorderTransformerPorts: editing.reorderTransformerPorts,
        removeTransformerPort: editing.removeTransformerPort,
      },
      editing.interaction,
    ),
    menuPosition,
