...
export const GRAPH_COMMAND_TYPES = {
  ...
  addUpdateAction: "graph.addUpdateAction",
  setUpdateTarget: "graph.setUpdateTarget",
  setUpdateOperation: "graph.setUpdateOperation",
  setUpdateOperand: "graph.setUpdateOperand",
