      ...
      <div
        ...
        className={cn(
          ...
          vibe === "inspector"
            ...
            : vibe === "table"
              ? "h-full min-h-8 rounded-none border-0 bg-transparent dark:bg-transparent"
              : "",
          className,
        )}
        {...props}
...
const inputGroupAddonVariants = cva(
  "flex h-auto cursor-text items-center justify-center gap-2 py-1.5 text-sm font-medium text-muted-foreground select-none group-data-[disabled=true]/input-group:opacity-50 [&>kbd]:rounded-[calc(var(--radius)-5px)] [&>svg:not([class*='size-'])]:size-4 empty:hidden",
  {
    variants: {
      align: {
